...
{
    this->buffer = new CGKColor3<REAL>[width*height];
    std::memset(this->buffer, 0, sizeof(CGKColor3<REAL>)*width*height);
}
//------------------------------------------------------------------------------
template<typename REAL>
...
//------------------------------------------------------------------------------
template<typename REAL>
CGKColor3<REAL>& Framebuffer<REAL>::Pixel(int i, int j)
{
...
//------------------------------------------------------------------------------
template<typename REAL>
void Framebuffer<REAL>::SetClearColor(const CGKColor3<REAL>& color)
{
